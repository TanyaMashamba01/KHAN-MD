...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY Joshking01-MD 🤍*",
// set the auto reply massage on status reply  
PREFIX: process.env.PREFIX || "!",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "JoshKing01-MD",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "JoshKing-MD",
...
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *Joshuamambo-MD*⚡",
// add alive msg here 
